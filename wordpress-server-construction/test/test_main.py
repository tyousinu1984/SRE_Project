...
def test_main_Normal003():
    ...
    print(f"{sys._getframe().f_code.co_name} start")
    args_info = {'host_name': 'fanne.co.jp', 'key_name': 'fannecojp',
                 'account': 'fanne', 'stage': 'prod', 'instance_type': 't3.medium', 'availability_zone': 'A',
                 'ami': 'ami-002cedb74d7169fa1', 'ebs_size': '50', 'termination_protection': 'true',
                 'caller_user_id': '530605', 'caller_room_id': '250157426', 'stack_name': 'fanne-co-jp'}
